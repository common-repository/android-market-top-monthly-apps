...
//  Adding Action
add_action('plugins_loaded','monthly_display_widget');

//  Display Widget
function monthly_display_widget() {
    register_sidebar_widget(__('Top Monthly RawApps Android Widget'),'monthly_rawapps_widget');
    register_widget_control('Top Monthly RawApps Android Widget','monthly_widget_options');

}
//  Creating RawApps  widget
function monthly_rawapps_widget($args) {
    extract($args);
   ...
   //   Widget Control Panel
	...
	echo "<input type='hidden' id='monthly-rawapps-widget-submit' name='monthly-rawapps-widget-submit' value='1' />";
